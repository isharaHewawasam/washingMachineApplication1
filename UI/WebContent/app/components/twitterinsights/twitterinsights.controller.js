(function() {
	...
	angular
	    .module('angle')
	    .controller('TwitterInsightsController', TwitterInsightsController);
	
	TwitterInsightsController.$inject = ['$rootScope', '$scope', '$state', '$localStorage', "iot.config.ApiClient", 'HttpService'];
	
	function TwitterInsightsController($rootScope, $scope, $state, $localStorage, configApiClient, HttpService) {

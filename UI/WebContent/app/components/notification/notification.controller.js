(function() {
	...
	angular
	    .module('angle')
	    .controller('NotificationConfController', NotificationConfController);
	
	NotificationConfController.$inject = ['$rootScope', '$scope', '$state', '$window', '$localStorage', "iot.config.ApiClient", 'HttpService'];
